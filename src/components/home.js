    ...
    return (
      <div className="row" style={{margin: "50px"}}>
        ...
        <div className="col-sm-8">
          ...
          <div><img src={process.env.PUBLIC_URL + "/assets/honda.jpg"} width="100%" alt="Honda Shadoow" /></div>
          ...
          <div><img src={process.env.PUBLIC_URL + "/assets/EBC.JPG"} width="100%" alt="Everest Base Camp" /></div>
